...
# EXAMPLE: BOX -> ros2 run robotic_arms_control spawn_obj --package "robotic_arms_control" --urdf "box.urdf" --name "box" --x 0.698 --y 0.02 --z 0.1274
...
def main():
    ...
    parser.add_argument('--y', type=float, default=-0.02, help='the y component of the initial position [meters].')
